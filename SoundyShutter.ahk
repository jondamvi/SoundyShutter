...
;@Ahk2Exe-SetProductVersion 1.4.0.0
;@Ahk2Exe-SetProductName SoundyShutter
;@Ahk2Exe-SetDescription Plays selected sound when doing video screenshots
;@Ahk2Exe-SetOrigFilename SoundyShutter.exe
;@Ahk2Exe-SetMainIcon SoundyShutter.ico
;
...
; ------------------------------------------------------------------------------
global ConfigFile := A_ScriptDir . "\SoundyShutter_config.json"
...
global CaptureKeys             := "c,XButton1,XButton2"
...
RegisterHotkeys() {
	...
	HotIfWinActive("ahk_exe mpc-be64.exe")
	HotIfWinActive("ahk_exe mpc-hc.exe")
	HotIfWinActive("ahk_exe mpc-be.exe")
    HotIfWinActive("ahk_exe vlc.exe")
